...
async fn reconcile(
    ...
    let name = kafkaTopic.name_any(); // Name of the Echo resource is used to name the subresources as well.
...
fn on_error(echo: Arc<KafkaTopic>, error: &Error, _context: Arc<ContextData>) -> Action {
